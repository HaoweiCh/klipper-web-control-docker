...
ENV PKGLIST="${PKGLIST} python2 virtualenv python-dev gpiod"
ENV PKGLIST="${PKGLIST} python3-virtualenv python3-dev libopenjp2-7 python3-libgpiod liblmdb-dev libsodium-dev"
